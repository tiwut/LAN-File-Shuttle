        ...
        while self._is_running:
            try:
                ...
                for ip in list(self._last_seen.keys()):
                    if current_time - self._last_seen[ip] > 15:
...
class FileTransferApp(QWidget):
    def __init__(self):
        ...
        QTimer.singleShot(1000, self.start_receiving) # Automatischer Start des Empfangsservers
    ...
    def update_device_list_ui(self):
        ...
        for key in list(self.discovered_devices.keys()):
            if current_time - self.discovered_devices[key]['last_seen'] > 15:
    ...
    def start_receiving(self):
        ...
        # Die Buttons werden jetzt nicht mehr deaktiviert, da sie entfernt wurden.
    ...
    def stop_receiving(self):
        ...
        # Die Buttons werden nicht mehr aktiviert/deaktiviert
...
if __name__ == '__main__':
    ...
    app.setOrganizationName("FileTransfer Solutions")
